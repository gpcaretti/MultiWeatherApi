...
namespace MultiWeatherApi {
    ...
    internal static class DateTimeHelper {
        ...
        /// </summary>
        public static readonly DateTimeOffset BaseUnixTime = new DateTimeOffset(1970, 1, 1, 0, 0, 0, new TimeSpan());
        ...
        /// <returns><see cref="DateTime"/> representing the given Unix time.</returns>
